...
export default async function StockInPage({
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Barang Masuk</h1>
        <p className="mt-1 text-sm text-slate-500 dark:text-slate-400">Catat pembelian atau penerimaan barang</p>
      </div>
